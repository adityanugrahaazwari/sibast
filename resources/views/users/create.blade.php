...
<div class="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md">
    <h2 class="text-2xl font-bold mb-6 text-gray-900">Tambah User Baru</h2>
    ...
    <form action="{{ route('users.store') }}" method="POST">
        ...
        <div class="flex items-center justify-between">
            ...
            <button type="submit" class="bg-indigo-600 text-white py-2 px-6 rounded-md hover:bg-indigo-700">Simpan User</button>
        </div>
    </form>
</div>
@endsection
